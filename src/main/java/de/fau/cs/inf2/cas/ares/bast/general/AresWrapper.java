...
public class AresWrapper implements INodeWrapper {
  private final AbstractBastNode node;
  public List<INode> nodeDirectChildren = new LinkedList<INode>();
   ...
   * @param node the node
   */
  public AresWrapper(AbstractBastNode node) {
    this.node = node;
  }
   ...
   */
  public AresWrapper(AbstractBastNode node, HashMap<AbstractBastNode, INode> wrapperMap,
    ...
    if (wrapperMap != null && childrenMap != null) {
      ...
      if (children != null) {
        for (AbstractBastNode child : children) {
          ...
          if (childNode == null) {
            childNode = new AresWrapper((AbstractBastNode) child, wrapperMap, childrenMap);
   ...
   * @return the string
   */
  public static String staticGetValue(AbstractBastNode node) {
    switch (node.getTag()) {
